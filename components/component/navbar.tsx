    ...
    <header className={`w-full bg-white bg-opacity-90 absolute top-0 left-0 z-50`}>
      <div className="max-w-7xl mx-auto px-8 py-8 flex items-center justify-between">
        <nav className="hidden md:flex items-center gap-4 text-sm font-medium">
          ...
          <Button variant="outline" className="absolute w-full sm:w-auto bg-azure-radiance-950 text-white rounded-3xl flex items-center justify-center px-6 py-6 xl:text-lg text-sm border border-azure-radiance-950" style={{ color: 'black', backgroundColor: 'white', borderWidth: "1px", right:"10rem" }}>
            Télécharger mon CV
