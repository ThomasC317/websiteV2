...
>
    ...
    >
        ...
        />
          ...
          <Button className="w-full sm:w-auto bg-azure-radiance-950 text-white rounded-3xl flex items-center justify-center px-6 py-4 text-2xl border border-azure-radiance-950" style={{ color: 'black', backgroundColor: 'white', borderWidth: "1px" }}>
            Télécharger mon CV
  ...
  <div className="flex" style={{alignItems:"baseline"}}> <Trema />    <h2 className="text-2xl mb-4 ml-4">Compétences métier</h2></div>
    ...
    <div className="mb-3 flex items-center">
      ...
      <p className="ml-2 text-lg">Autonomie, collaboration, gestion du stress, adaptabilité.</p>
                ...
                <div className="flex" style={{alignItems:"baseline"}}> <Trema />    <h2 className="text-2xl mb-4 ml-4">Projets</h2>  
                    <select
                        id="companyFilter"
                        name="companyFilter"
                        className="rounded-3xl text-lg ml-4 px-4 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
    ...
    return (
        <div
            key={index}
            className={`bg-hover-transition px-8 py-2 ${isExpanded ? "border-b" : ""} border-color-lightgray cursor-pointer relative`}
        ...
        >
            <div className="relative">
                <table className="w-full">
                    <tbody>
                        <tr>
                            <td className="w-1/16 text-lg">{project.finishYear}</td>
                            <td className="w-1/4 text-lg">{project.title}</td>
                            <td className="w-1/4 text-lg">{project.company}</td>
            ...
            <div className="absolute right-0 transform -translate-x-1/2 -translate-y-1/2 transition-transform" style={{ top: "22px" }}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex" style={{alignItems:"baseline"}}> <Trema />    <h2 className="text-2xl mb-4 ml-4">Applications/Outils</h2></div>
                    <div className="mb-3 flex">
                        <a href="https://code.visualstudio.com/" className="underline-link whitespace-nowrap text-azure-radiance-500 text-lg">VS Code </a>
                        <Trema />
                        <p className="ml-2 text-lg">Un des meilleurs éditeurs de code que j'ai pu tester, très customisable.</p>
                    </div>
                    <div className="mb-3 flex">
                        <a href="https://github.com/" className="underline-link whitespace-nowrap text-azure-radiance-500 text-lg">GitHub </a>
                        <Trema />
                        <p className="ml-2 text-lg">La feature des pages est assez folle pour hoster des sites facilement, très pratique pour les portfolios notamment.</p>
                    </div>
                    <div className="mb-3 flex">
                        <a href="https://www.sonarsource.com/" className="underline-link whitespace-nowrap text-azure-radiance-500 text-lg">Sonarlint/Cloud </a>
                        <Trema />
                        <p className="ml-2 text-lg">J'ai beau avoir travaillé peu avec, l'utilité est impressionante. Très simple à installer et la qualité de code est rapidement améliorée.</p>
                    </div>
                    <div className="mb-3 flex">
                        <a href="https://azure.microsoft.com/fr-fr/products/devops" className="underline-link whitespace-nowrap text-azure-radiance-500 text-lg">Azure Devops </a>
                        <Trema />
                        <p className="ml-2 text-lg">L'ensemble des features est très appréciable. Avoir accès au Kanban, aux repositories, a la création d'artifacts et aux pipelines sur la même plateforme... ça m'a été très utile.</p>
                    </div>
                    <div className="mb-3 flex">
                        <a href="https://www.google.com/intl/fr/drive/" className="underline-link whitespace-nowrap text-azure-radiance-500 text-lg">Google Workspace </a>
                        <Trema />
                        <p className="ml-2 text-lg">Gratuit & très complet, pas besoin de dire grand chose de plus.</p>
                    </div>
                    <div className="mb-3 flex">
                        <a href="https://www.canva.com/" className="underline-link whitespace-nowrap text-azure-radiance-500 text-lg">Canva </a>
                        <Trema />
                        <p className="ml-2 text-lg">Très utile pour créer des schémas, des documents textes en tout genre, ou même des présentations. Je ne suis pas fan de la disparition des applications tierces cependant.</p>
                    </div>
                    <div className="mb-3 flex">
                        <a href="https://v0.dev/" className="underline-link whitespace-nowrap text-azure-radiance-500 text-lg">V0 Dev </a>
                        <Trema />
                        <p className="ml-2 text-lg">Génération par IA d'interfaces simples. Très utile pour générer des composants en React.</p>
                    </div>
                </div>
            </div>
        </main>
