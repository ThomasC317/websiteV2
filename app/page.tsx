...
const handleButtonClick = () => {
  ...
  return (
    <div className="min-h-screen flex xl:flex-row flex-col items-center md:justify-center justify-between py-12 bg-gray-100 xl:mt-16">
...
>
    ...
    >
        ...
        />
          ...
          <Button variant="outline" className="w-full sm:w-auto bg-azure-radiance-950 text-white rounded-3xl flex items-center justify-center px-6 py-6 text-2xl border border-azure-radiance-950" style={{ color: 'black', backgroundColor: 'white', borderWidth: "1px" }}>
            Télécharger mon CV
